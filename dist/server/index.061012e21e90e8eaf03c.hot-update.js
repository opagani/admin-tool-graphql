        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.post("".concat(_utils_api__WEBPACK_IMPORTED_MODULE_7__[/* api */ "a"].gql.cancelPolicy), {
              ...
              _server_utils_log__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].error("Error cancelling policy for policyId: ".concat(policyId, ": ").concat(err)); // Log an error (using the class instance's logger):
          ...
          case 2:
            ...
            return _server_utils_nodeMonitor__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"].increment({
              name: 'rent-guarantee-graphql.cancelPolicy.viewed',
              amount: 1
            });
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("".concat(_utils_api__WEBPACK_IMPORTED_MODULE_7__[/* api */ "a"].gql.expandedPolicyDetails, "?policyId=").concat(policyId), {
              ...
              _server_utils_log__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].error("Error fetching policy for policyId: ".concat(policyId, ": ").concat(err)); // Log an error (using the class instance's logger):
          ...
          case 2:
            ...
            _context.next = 6;
            return _server_utils_nodeMonitor__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"].increment({
              name: 'rent-guarantee-graphql.getExpandedPolicyDetails.viewed',
              amount: 1
            });
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("".concat(_utils_api__WEBPACK_IMPORTED_MODULE_7__[/* api */ "a"].gql.historyForPolicyRelatedActions, "?policyId=").concat(policyId), {
              ...
              _server_utils_log__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].error("Error fetching history for policy related actions for for policyId: ".concat(policyId, ": ").concat(err)); // Log an error (using the class instance's logger):
          ...
          case 2:
            ...
            _context.next = 6;
            return _server_utils_nodeMonitor__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"].increment({
              name: 'rent-guarantee-graphql.getHistoryForPolicyRelatedActions.viewed',
              amount: 1
            });
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("".concat(_utils_api__WEBPACK_IMPORTED_MODULE_5__[/* api */ "a"].gql.reports), {
              ...
              _server_utils_log__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"].error("Error fetching reports: ".concat(err));
              return null;
            });
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("".concat(_utils_api__WEBPACK_IMPORTED_MODULE_7__[/* api */ "a"].gql.history, "?logIdType=").concat(searchType, "&logIdValue=").concat(searchValue), {
              ...
              _server_utils_log__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].error("Error fetching history for searchValue: ".concat(searchValue, ": ").concat(err)); // Log an error (using the class instance's logger):
          ...
          case 2:
            ...
            _context.next = 5;
            return _server_utils_nodeMonitor__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"].increment({
              name: 'rent-guarantee-graphql.getHistory.viewed',
              amount: 1
            });
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("".concat(_utils_api__WEBPACK_IMPORTED_MODULE_7__[/* api */ "a"].gql.policySearchTypes), {
              ...
              _server_utils_log__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].error("Error fetching policy for policy search types: ".concat(err)); // Log an error (using the class instance's logger):
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("".concat(_utils_api__WEBPACK_IMPORTED_MODULE_7__[/* api */ "a"].gql.policyStatuses), {
              ...
              _server_utils_log__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].error("Error fetching policy statuses search types: ".concat(err)); // Log an error (using the class instance's logger):
          ...
          case 2:
            ...
            _context.next = 6;
            return _server_utils_nodeMonitor__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"].increment({
              name: 'rent-guarantee-graphql.getPolicyStatuses.viewed',
              amount: 1
            });
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("".concat(_utils_api__WEBPACK_IMPORTED_MODULE_7__[/* api */ "a"].gql.searchPolicies, "?searchType=").concat(searchType, "&searchValue=").concat(searchValue), {
              ...
              _server_utils_log__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].error("Error fetching policy for ".concat(searchType, ": ").concat(searchValue, ": ").concat(err)); // Log an error (using the class instance's logger):

              // Log an error (using the class instance's logger):
              _server_utils_nodeMonitor__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"].error({
                error: err
              });
              return null;
            });
          ...
          case 2:
            ...
            return _server_utils_nodeMonitor__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"].increment({
              name: 'rent-guarantee-graphql.getSearchPolicies.viewed',
              amount: 1
            });
...
//# sourceMappingURL=index.061012e21e90e8eaf03c.hot-update.js.map