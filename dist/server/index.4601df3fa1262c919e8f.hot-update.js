...
var logger = _server_utils_log__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].child('services/getSearchPolicies');
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("".concat(_utils_api__WEBPACK_IMPORTED_MODULE_7__[/* api */ "a"].gql.searchPolicies, "?searchType=").concat(searchType, "&searchValue=").concat(searchValue), {
              ...
              logger.error("Error fetching policy for ".concat(searchType, ": ").concat(searchValue, ": ").concat(err)); // Log an error (using the class instance's logger):
...
//# sourceMappingURL=index.4601df3fa1262c919e8f.hot-update.js.map