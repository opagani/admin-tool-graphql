    ...
    _defineProperty(this, "getStatusCode", function (req) {
      if (_this.isShuttingDown) {
        ...
        if (_this.shouldIgnoreShutdown(req)) {
          ...
          (_this$logger3 = _this.logger) === null || _this$logger3 === void 0 ? void 0 : _this$logger3.warn("app is ignoring shutdown mode, returning status code=".concat(GOOD_STATUS_CODE, " because of query=").concat(JSON.stringify(req.query)));
...
//# sourceMappingURL=index.9252f4dcdf4b2eeb998e.hot-update.js.map