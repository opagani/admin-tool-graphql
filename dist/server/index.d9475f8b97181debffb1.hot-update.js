...
var logger = _server_utils_log__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].child('services/getExpandedPolicyDetails');
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("".concat(_utils_api__WEBPACK_IMPORTED_MODULE_7__[/* api */ "a"].gql.expandedPolicyDetails, "?policyId=").concat(policyId), {
              ...
              logger.error("Error fetching policy for policyId: ".concat(policyId, ": ").concat(err)); // Log an error (using the class instance's logger):
...
//# sourceMappingURL=index.d9475f8b97181debffb1.hot-update.js.map