...
var logger = _server_utils_log__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].child('services/cancelPolicy');
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.post("".concat(_utils_api__WEBPACK_IMPORTED_MODULE_7__[/* api */ "a"].gql.cancelPolicy), {
              ...
              logger.error("Error cancelling policy for policyId: ".concat(policyId, ": ").concat(err)); // Log an error (using the class instance's logger):
...
//# sourceMappingURL=index.7d1cdb99f5f17e5f52e6.hot-update.js.map