        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("".concat(url), {
              ...
              logger.error("Error fetching Landlords ".concat(methodToInvoke, " report: ").concat(err)); // Log an error (using the class instance's logger):
...
//# sourceMappingURL=index.e0bb02d6852e22c3b4e5.hot-update.js.map